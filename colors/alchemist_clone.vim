" Name:         alchemist clone
" Description:  Just a clone of vim-alchemist colorscheme.
" Author:       AT-AT
" Maintainer:   AT-AT
" License:      Vim License (see `:help license`)
" Last Updated: 月  1/23 13:57:12 2023
...
hi clear
let g:colors_name = 'alchemist_clone'

let s:t_Co = exists('&t_Co') && !has('gui_running') ? +&t_Co : -1

if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#af5f5f', '#5f875f', '#af8700', '#5f87af', '#5f5f87', '#5f8787', '#6c6c6c', '#444444', '#d7875f', '#87af87', '#d7af5f', '#87afd7', '#8787af', '#87afaf', '#ffffff']
endif
if has('nvim')
...
if get(g:, 'alchemist_clone_transp_bg', 0) && !has('gui_running')
  hi Normal guifg=#bcbcbc guibg=NONE gui=NONE cterm=NONE
else
  hi Normal guifg=#bcbcbc guibg=#070707 gui=NONE cterm=NONE
endif
hi EndOfBuffer guifg=#444444 guibg=NONE gui=NONE cterm=NONE
hi Statusline guifg=#070707 guibg=#5f8787 gui=NONE cterm=NONE
hi StatuslineNC guifg=#bcbcbc guibg=#444444 gui=NONE cterm=NONE
hi StatuslineTerm guifg=#070707 guibg=#5f8787 gui=NONE cterm=NONE
...
hi PmenuSel guifg=#070707 guibg=#d7af5f gui=NONE cterm=NONE
...
hi TabLineSel guifg=#070707 guibg=#5f8787 gui=NONE cterm=NONE
hi ToolbarLine guifg=NONE guibg=#1c1c1c gui=NONE cterm=NONE
hi ToolbarButton guifg=#070707 guibg=#87af87 gui=NONE cterm=NONE
...
hi Visual guifg=#070707 guibg=#87afd7 gui=NONE cterm=NONE
hi VisualNOS guifg=#070707 guibg=#87afd7 gui=NONE cterm=NONE
...
hi CursorLineNr guifg=#ffaf5f guibg=#1c1c1c gui=bold cterm=bold
...
hi ErrorMsg guifg=#af5f5f guibg=NONE gui=reverse cterm=reverse
hi ModeMsg guifg=#070707 guibg=#af8700 gui=NONE cterm=NONE
hi WarningMsg guifg=#d7875f guibg=NONE gui=NONE cterm=NONE
hi MoreMsg guifg=#87af87 guibg=NONE gui=NONE cterm=NONE
hi Question guifg=#8787af guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=#070707 guibg=#6c6c6c gui=NONE cterm=NONE
hi MatchParen guifg=#1c1c1c guibg=#af8700 gui=NONE cterm=NONE
hi Search guifg=#1c1c1c guibg=#fed06e gui=NONE cterm=NONE
hi IncSearch guifg=#1c1c1c guibg=#d7af5f gui=NONE cterm=NONE
hi WildMenu guifg=#070707 guibg=#d7af5f gui=NONE cterm=NONE
hi ColorColumn guifg=NONE guibg=#1c1c1c gui=NONE cterm=NONE
hi Cursor guifg=#070707 guibg=#ffaf5f gui=NONE cterm=NONE
hi lCursor guifg=#070707 guibg=#af5f5f gui=NONE cterm=NONE
hi DiffAdd guifg=#070707 guibg=#87af87 gui=NONE cterm=NONE
hi DiffChange guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi DiffText guifg=#070707 guibg=#8787af gui=NONE cterm=NONE
hi DiffDelete guifg=#af5f5f guibg=#1c1c1c gui=NONE cterm=NONE
...
hi Tag guifg=#87afaf guibg=NONE gui=NONE cterm=NONE
hi SpecialComment guifg=#87afaf guibg=NONE gui=NONE cterm=NONE
hi Directory guifg=#87afaf guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if get(g:, 'alchemist_clone_transp_bg', 0)
  ...
  hi Search ctermfg=234 ctermbg=217 cterm=NONE
